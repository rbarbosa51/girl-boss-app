  ...
  return (
    <Card className="p-4 bg-red-200/40 rounded-lg shadow-md">
      ...
      <p className="text-center indent-4 mb-2 mx-4">
        This Task Board (Kanban) board will help you organize your tasks based
        on completion status. This can be extremely useful in organizing your
        ideas and relieve stress.
      </p>
      <Separator className="w-[90%] mx-auto mt-2 mb-4 bg-slate-400" />
      <ul className="w-[50%] mx-auto list-disc my-2 text-center">
        <li>
          <strong className="underline">Drag and drop</strong> tasks from column
          to columns.
        </li>
        <li>
          <strong className="underline">Double click</strong> a task to edit it.
        </li>
        <li>
          On the dialog box, write your task under summary and then click{" "}
          <strong className="underline">Save</strong>.
        </li>
        <li>
          Once you are finished editing, click on the{" "}
          <strong className="underline">Save Data</strong>
        </li>
      </ul>
      <KanbanComponent
        id="kanban"
